...
{
    return [[self alloc] initWithType:MPABTestDesignerDeviceInfoRequestMessageType];//self.type = @"device_info_request"
}
...
- (NSOperation *)responseCommandWithConnection:(MPABTestDesignerConnection *)connection
{
    ...
    NSOperation *operation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{//deviceInfoResponseMessage属性赋值
...
- (NSArray *)availableFontFamilies//得到本机所有字体于fontFamilies
{
