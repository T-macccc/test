...
+ (MPVariant *)variantWithJSONObject:(NSDictionary *)object {//MPVariant 初始化并赋值
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder//解归档
{
    if (self = [super init]) {
...
{
    NSEnumerator *selectorEnum = [gettersForSetters keyEnumerator];//获得key
