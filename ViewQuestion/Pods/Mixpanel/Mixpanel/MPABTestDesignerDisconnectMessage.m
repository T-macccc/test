...
{
    return [[self alloc] initWithType:MPABTestDesignerDisconnectMessageType];//self.type = @"disconnect"
}
...
- (NSOperation *)responseCommandWithConnection:(MPABTestDesignerConnection *)connection
{
    ...
    NSOperation *operation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        MPVariant *variant = [connection sessionObjectForKey:kSessionVariantKey];//self.session[@"session_variant"]
        if(variant) {
