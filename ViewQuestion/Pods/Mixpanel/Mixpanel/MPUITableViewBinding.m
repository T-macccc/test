...
+ (MPEventBinding *)bindingWithJSONObject:(NSDictionary *)object//用object初始化一个MPUITableViewBinding对象
{
...
- (UITableView *)parentTableView:(UIView *)cell {//迭代找到包含cell的tableView
